      ...
      if (event.target.classList.contains("cta")) {
         ...
         if (event.target.dataset.id == 3) {
            ...
            <section class="section-container flex-col clr-white flex-ctr-xy flex-gap-40 bg-black">
              ...
              <p>Rainydays is a e-commerce website we where tasked to create that sells rain jackets. This using html, CSS and JavaScript</p>
          ...
          `;
            ...
            <section class="section-container flex-col clr-white flex-ctr-xy flex-gap-40 bg-black">
               ...
               <p>Community science museum is an website we where tasked to create using html and CSS, and is design to inform and attract visitors to an local museum</p>
               <div class="flex flex-gap-40 flex-ctr-y">
          ...
          <section class="section-container flex-col clr-white flex-ctr-xy flex-gap-40 bg-black">
              ...
              <p>In this website we where tasked to design and build a blog of choice to showcase our Html, CSS, JavaScript and Wordpress skills. I choose to create a Fitness/Nutrition blog for this assignment</p>
              <div class="flex flex-gap-40 flex-ctr-y">
